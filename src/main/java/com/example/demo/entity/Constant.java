...
public class Constant {
    ...
    public static final String SIGN_ACCESS_KEY_ID = "LTAI6zgLiRwPy5U4";
    public static final String SIGN_SECRET = "6xHshujvHhU5cQDHTzeED0A96MhMOl";
    public static final String SIGN_NAME = "金禅产融孵化器";
    public static final String SMS_REGISTET = "SMS_71860213";
    public static final String SMS_RESET_PASSWORD = "SMS_176005291";
